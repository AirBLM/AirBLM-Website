  ...
  // console.log(ppeDonations);
    ...
    <CardContent>
        ...
        <Typography className="ppe-items" style={{ 'font-size': '10px' }}>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[0]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[1]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[2]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[3]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[4]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[5]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[6]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[7]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[8]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[9]}</span>
            <span className="ppe-donation-type">{ppeDonation.fields.Attachments[10]}</span>
        </Typography>
    </CardContent>
    <CardActions className="ppe-actions" style={{ 'justify-content': 'center' }}>
        <Button size="small" href={ppeDonation.fields["Donation Link"]} target="_blank">
            Learn More
        </Button>
    </CardActions>
    <Typography className="ppe-contact" style={{ 'font-size': '12px'}}>
          <a href={`mailto:${ppeDonation.fields["Preferred Method of Contact"]}`} style={{ 'color': '#3199e4'}}>
    ...
    const donationsJsx = donations.map(donation => (
      ...
      <CardActions className="donation-actions" style={{ 'display': 'block' }}>
          <Button size="small" href={donation.fields.Link} target="_blank" style={{ 'margin-left': '10px' }}>
              Learn More
          </Button>
          <Button size="small" color="secondary" href={donation.fields["Donation Link"]} target="_blank">
              Take Action
          </Button>
      </CardActions>
      </Card>
