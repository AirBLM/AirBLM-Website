...
import Emily from '../assets/image.jpg'
...
const About = () => {
    return(
        ...
        <Team photo = {Ying} name = 'Ying Songsana' title = 'Frontend Developer'></Team>
        <Team photo = {Emily} name = 'Emily Kwok' title = 'Frontend Developer'></Team>
        </div>
